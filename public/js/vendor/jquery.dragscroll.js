...
(function ($, global) {
	...
	$.extend(DragScroll.prototype, {
		...
		_bind: function () {
			...
			if (this.options.ignoreMouseWheel === false) {
			...
			this.elem
			.bind('mouseenter', $.proxy(this.showBars, this))
			.bind('mouseleave', $.proxy(this.hideBars, this))
		...
		hideBars: function () {
			...
			this.scrollBarContainer.each(function () {
				this.stop().delay(800).fadeTo(250, 0);
