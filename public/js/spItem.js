...
(function(requirejs) {
    'use strict';
    requirejs(['jquery', 'ajax', 'common', 'slide', 'formVerified', 'addressBox', 'handlebars', 'paginate', 'dial', 'info', 'dialog', 'addrsCtrl', 'chosen','message','placeholder'], function($, Ajax, common, slide, FormVerified, addressBox, Handlebars, Paginate, dial, info, dialog, addrsCtrl, chosen,Message,placeholder) {
        var Sphome = function() {
        ...
        Sphome.prototype = {
            ...
            sortRet: function(obj) {
              ...
              if(this.titleArr.length == 4){
                    if(field == 'hot'){
                        if(condition == 'asc'){
                            setTitle = this.titleArr[0]+"_"+this.titleArr[1]+"_"+this.titleArr[2]+"【按热门从低到高】"+"_"+this.titleArr[3];
                        }else{
                            setTitle = this.titleArr[0]+"_"+this.titleArr[1]+"_"+this.titleArr[2]+"【按热门从高到低】"+"_"+this.titleArr[3];
                        }
                    }else if(field == 'evaluate'){
                        if(condition == 'asc'){
                            setTitle = this.titleArr[0]+"_"+this.titleArr[1]+"_"+this.titleArr[2]+"【按好评从低到高】"+"_"+this.titleArr[3];
                        }else{
                            setTitle = this.titleArr[0]+"_"+this.titleArr[1]+"_"+this.titleArr[2]+"【按好评从高到低】"+"_"+this.titleArr[3];
                        }
                    }else if(field == 'price'){
                        if(condition == 'asc'){
                            setTitle = this.titleArr[0]+"_"+this.titleArr[1]+"_"+this.titleArr[2]+"【按价格从低到高】"+"_"+this.titleArr[3];
                        }else{
                            setTitle = this.titleArr[0]+"_"+this.titleArr[1]+"_"+this.titleArr[2]+"【按价格从高到低】"+"_"+this.titleArr[3];
                        }
                    } else{
            ...
            searchRet: function() {
             ...
             filter: function () {
                ...
                qryList: function (paramsObj) {
                    ...
                    delete params.func;
                    var request = new Ajax('/servicer/gotoServicePage4Ajax.htm', params);
                    request.done(function (data) {
                        if (data.status === "200") {
