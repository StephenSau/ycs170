(function (requirejs) {
    ...
    requirejs(['jquery', 'common', 'formVerified', 'dialog', 'chosen'], function ($, common, FormVerified, dialog) {
    	...
    	IncomeTax.resultTitle = {
    		"grsds": "个人所得税计算结果",
    		"shgz": "税后工资计算结果",
    		"nzj": "年终奖个人所得税计算结果",
    		"lwbc": "劳务报酬所得税计算结果",
    		"gtgsh": "个体工商户生产、经营所得税计算结果",
    		"cbcz": "对企事业单位承包承租经营所得个税计算结果",
    		"gcsd": "稿酬所得个税计算结果",
    		"txq": "特许权使用费所得税计算结果",
    		"cczl": "财产租赁所得税计算结果",
    		"cczr": "财产转让所得税计算结果",
    		"lxhl": "利息、股息、红利所得税计算结果",
    		"orsd": "偶然所得税（中彩，中奖税）计算结果"
    	};
    	...
    	IncomeTax.prototype = {
    		...
    		changeForm: function (type) {
                ...
                } else if (type === "gcsd" || type === "txq" || type === "cczl") {
                    this.printResult([{
                        name: "扣除费用",
                        value: 0,
                        unit: "元"
                ...
                } else if (type === "cczr" || type === "lxhl" || type === "orsd") {
                    this.printResult([{
                        name: "应纳税所得额",
                        value: 0,
                        unit: "元"
            ...
            formula_cbcz: function (income, insure, base, months) {
                var taxableIncome = income - months * 3500,
                    a = income - months * 3500,
                    r = 0,
                    q = 0,
                    tax = 0,
                    realIncome = 0;
